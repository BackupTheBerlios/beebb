...
INSERT INTO `Bee_Podfora`(`ID`,`Tytul`,`Opis`,`DataOstWypowiedzi`,`AutorOstWypowiedzi`,`IDOstWatku`,`Aktywne`,`LiczbaWatkow`,`LiczbaWypowiedzi`) VALUES
(1,'Tyskie','Dobre piwko',NOW(),'Guest',NULL,'T',1,1),
(2,'Warka','Tez dobre piwko',NOW(),'',NULL,'T',0,0),
(3,'Lech','Rownież dobre piwko',NOW(),'',NULL,'T',0,0),
(4,'Carlsberg','Probably the Best Beer in the World',NOW(),'',NULL,'T',0,0);
UNLOCK TABLES;
