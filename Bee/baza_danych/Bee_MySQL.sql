...
CREATE TABLE `Bee_Users` (
  ...
  `Tlen` varchar(100) NOT NULL default '',
  `TlenPrywatny` enum('T','N') NOT NULL default 'N',
  `WPKontakt` varchar(100) NOT NULL default '',
  `WPKontaktPrywatny` enum('T','N') NOT NULL default 'N',
  `ICQ` varchar(100) NOT NULL default '',
  `ICQPrywatne` enum('T','N') NOT NULL default 'N',
  `Msn` varchar(100) NOT NULL default '',
  `MsnPrywatny` enum('T','N') NOT NULL default 'N',
  `Yahoo` varchar(100) NOT NULL default '',
  `YahooPrywatne` enum('T','N') NOT NULL default 'N',
  `Skype` varchar(100) NOT NULL default '',
  `SkypePrywatny` enum('T','N') NOT NULL default 'N',
  `Miasto` varchar(100) NOT NULL default '',
  `MiastoPrywatne` enum('T','N') NOT NULL default 'N',
  `Plec` enum('K','M') NOT NULL,
  `Avatar` varchar(100) NOT NULL default '',
  `Sygnaturka` varchar(200) NOT NULL default '',
  `SygnaturkaPubliczna` enum('T','N') NOT NULL default 'N',
  `Styl` varchar(10) NOT NULL default '',
  `Jezyk` varchar(5) NOT NULL default '',
  `Powiadamianie` enum('T','N') NOT NULL default 'N',
  `DataUrodzenia` datetime NOT NULL default '1900-01-01 00:00:00', 
  `DataUrodzeniaPrywatna` enum('T','N') NOT NULL default 'N',
  `LiczbaWypowiedzi` int(10) unsigned NOT NULL default 0,
  `LiczbaWatkow` int(10) unsigned NOT NULL default 0,
  `OstatnieLogowanie` datetime NOT NULL default '1970-01-01 00:00:00',
  `BierzaceLogowanie` datetime NOT NULL default '1970-01-01 00:00:00',
