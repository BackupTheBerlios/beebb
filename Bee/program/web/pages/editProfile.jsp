...
%>
        ...
        <br/><br/>
                   ...
                   <tr><th><%out.print(Messages.numberCreatedThreads());%></th><td class="tdLiczba">&nbsp; <%out.print(user.getLiczbaWatkow());%> &nbsp;<td></tr>
                   <tr><th><%out.print(Messages.numberWroteMessages());%></th><td class="tdLiczba">&nbsp; <%out.print(user.getLiczbaWypowiedzi());%> &nbsp;<td></tr>
                   </table><br/>
