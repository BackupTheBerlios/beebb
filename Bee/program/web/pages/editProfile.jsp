...
%>
                ...
                <form method="POST" action="editProfile.jsp">
                    <table align="center" class="tableProfile" border="0">
                        ...
                        <tr><th><% out.print(Messages.wielka(Messages.name()));%></th><td class="tdProfileField"><input type="text" name="imie" size="35" value="<% out.print(user.getImie());%>"></td><td class="tdProfileField" rowspan="2" valign="bottom"><input type="checkbox" name="imieNazwiskoPrywatne" <%if(!user.ifShowName()) out.print("checked");%>> <%out.print(Messages.hide());%> &nbsp;</td></tr>
                        <tr><th><% out.print(Messages.wielka(Messages.surename()));%></th><td class="tdProfileField"><input type="text" name="nazwisko" size="35" value="<% out.print(user.getNazwisko());%>"></td><td></td></tr>
