...
public class Wypowiedz {
    ...
    public void printJSP(javax.servlet.jsp.JspWriter strona) throws java.io.IOException {
        ...
        strona.println("<span style=\"cursor: pointer\" onclick=\"wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&op=edit')\" class=\"aEditWypowiedz\"><img src=\"../images/edit.gif\" alt=\"Edytuj\" border=\"0\"/></span>"); //TODO MESSAGES
        strona.println("<span style=\"cursor: pointer\" onclick=\"if (czyNaPewno('"+ Messages.wielka(Messages.areYouSure())+"')) wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&op=delete')\" class=\"aDeleteWypowiedz\"><img src=\"../images/delete.gif\" alt=\"Skasuj\" border=\"0\"/></span>");
        strona.println("</td><td align=\"right\">");
        strona.println("<span style=\"cursor: pointer\" onclick=\"if (czyNaPewno('"+ Messages.wielka(Messages.areYouSure())+"')) wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&id_autor="+this.ID_Autora+"&op=ban')\" class=\"aAutorBanWypowiedz\"><img src=\"../images/kick_user.gif\" alt=\"BanujAutora\" border=\"0\"/></span>");//INFO tu nie wyciagam ID_KAT boolean i po co ? Lepiej jednorazowo zrobic to na podstawie id wypowiedzi przy banie raz na 1000 ;)
        strona.println("<span style=\"cursor: pointer\" onclick=\"if (czyNaPewno('"+ Messages.wielka(Messages.areYouSure())+"')) wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&op=move\" class=\"aMoveWatek')\"><img src=\"../images/move.gif\" alt=\"Przenies\" border=\"0\"/></span>");//INFO tu nie wyciagam ID_KAT boolean i po co ? Lepiej jednorazowo zrobic to na podstawie id wypowiedzi przy banie raz na 1000 ;)
        strona.println("<span style=\"cursor: pointer\" onclick=\"if (czyNaPewno('"+ Messages.wielka(Messages.areYouSure())+"')) wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&op=block\" class=\"aBlockWatek')\"><img src=\"../images/lock.png\" alt=\"Zablokuj\" border=\"0\" /></span>");
        strona.println("<span style=\"cursor: pointer\" onclick=\"if (czyNaPewno('"+ Messages.wielka(Messages.areYouSure())+"')) wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&op=close\" class=\"aCloseWatek')\"><img src=\"../images/cut.gif\" alt=\"Zamknij\" border=\"0\"/></span>");//INFO tu nie wyciagam ID_KAT boolean i po co ? Lepiej jednorazowo zrobic to na podstawie id wypowiedzi przy banie raz na 1000 ;)
