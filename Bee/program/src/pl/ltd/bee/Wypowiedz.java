...
public class Wypowiedz {
    ...
    public void printJSP(javax.servlet.jsp.JspWriter strona) throws java.io.IOException {
        ...
        strona.println("<span style=\"cursor: pointer\" onclick=\"wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&amp;op=edit')\"><img src=\"../images/edit.gif\" alt=\"" + Messages.wielka(Messages.edit()) + "\" border=\"0\"/></span>"); 
        strona.println("<span style=\"cursor: pointer\" onclick=\"if (czyNaPewno('"+ Messages.wielka(Messages.areYouSure())+"')) wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&amp;op=delete')\"><img src=\"../images/delete.gif\" alt=\"" + Messages.wielka(Messages.delete()) + "\" border=\"0\"/></span>");
        strona.println("</td><td align=\"right\">");
        strona.println("<span style=\"cursor: pointer\" onclick=\"if (czyNaPewno('"+ Messages.wielka(Messages.areYouSure())+"')) wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&amp;id_autor="+this.ID_Autora+"&amp;op=ban')\" /><img src=\"../images/kick_user.gif\" alt=\"" + Messages.banAuthor() + "\" border=\"0\"/>");//INFO tu nie wyciagam ID_KAT bo i po co ? Lepiej jednorazowo zrobic to na podstawie id wypowiedzi przy banie raz na 1000 ;)
        strona.println("<span style=\"cursor: pointer\" onclick=\"if (czyNaPewno('"+ Messages.wielka(Messages.areYouSure())+"')) wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&amp;op=move')\" /><img src=\"../images/move.gif\" alt=\"" + Messages.wielka(Messages.move()) + "\" border=\"0\"/>");//INFO tu nie wyciagam ID_KAT bo i po co ? Lepiej jednorazowo zrobic to na podstawie id wypowiedzi przy banie raz na 1000 ;)
        strona.println("<span style=\"cursor: pointer\" onclick=\"if (czyNaPewno('"+ Messages.wielka(Messages.areYouSure())+"')) wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&amp;op=block')\" /><img src=\"../images/lock.png\" alt=\"" + Messages.wielka(Messages.block()) + "\" border=\"0\"/>");
        strona.println("<span style=\"cursor: pointer\" onclick=\"if (czyNaPewno('"+ Messages.wielka(Messages.areYouSure())+"')) wypowiedzLinkClick('moderating.jsp?wpid="+this.ID+"&amp;op=close')\" /><img src=\"../images/cut.gif\" alt=\"" + Messages.wielka(Messages.close()) + "\" border=\"0\"/>");//INFO tu nie wyciagam ID_KAT bo i po co ? Lepiej jednorazowo zrobic to na podstawie id wypowiedzi przy banie raz na 1000 ;)
