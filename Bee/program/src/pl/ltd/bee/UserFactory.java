...
public class UserFactory {
     ...
     */
    public static User getUser(String User_ID, String User_Login, String User_Haslo,String User_Imie,String User_Nazwisko, String User_Email, String User_gg, String User_Jabber, String User_LastLog, String User_Aktywny, String User_Admin, String User_Moderator) {
        ...
        return new RegisteredUser(userID,User_Login,User_Haslo,User_Imie,User_Nazwisko,User_Email,User_gg,User_Jabber,User_LastLog,User_Aktywny);
    }
